...
with open(os.path.join(data_path, 'keypoints/YouTubeASL.keypoints.train.json'), 'r') as f:
...
with h5py.File(os.path.join(data_path, 'keypoints/YouTubeASL.keypoints.train.0.h5'), 'r') as h5_file:
    clip_count = 0
